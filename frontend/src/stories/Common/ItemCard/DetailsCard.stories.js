import DetailsCard from '../../../features/common/ItemCard/DetailsCard';

export default {
  title: 'Common/DetailsCard',
...
export const DetailsCardDefaultMode = {
  args: {
    selectedItem: {
...
export const DetailsCardMaintenancePlanMode = {
  args: {
    selectedItem: {
