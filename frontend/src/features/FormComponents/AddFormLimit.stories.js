...
export default {
  title: 'CommonFormComponents/AddFormLimit',
  component: AddFormLimit,
  tags: ['autodocs'],
};

const Template = (args) => <AddFormLimit {...args} />;

export const AddFormLimitDefault = Template.bind({});

AddFormLimitDefault.args = {
  formFields: {
    name: {
      value: '',
      name: 'name',
