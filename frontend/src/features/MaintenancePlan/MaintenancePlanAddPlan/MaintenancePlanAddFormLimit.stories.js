...
export default {
  title: 'Maintenance/MaintenancePlan/MaintenancePlanAddFormLimit',
  component: MaintenancePlanAddFormLimit,
  tags: ['autodocs'],
};

const Template = (args) => <MaintenancePlanAddFormLimit {...args} />;

export const MaintenancePlanAddFormLimitDefault = Template.bind({});

MaintenancePlanAddFormLimitDefault.args = {
  formFields: {
    name: {
      value: '',
      name: 'name',
