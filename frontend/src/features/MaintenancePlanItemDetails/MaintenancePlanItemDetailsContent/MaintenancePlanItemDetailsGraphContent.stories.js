...
export default {
  title: 'Maintenance/MaintenancePlanItem/MaintenancePlanItemDetailsGraphContent',
  component: MaintenancePlanItemDetailsGraphContent,
  tags: ['autodocs'],
};

const Template = (args) => <MaintenancePlanItemDetailsGraphContent {...args} />;

export const MaintenancePlanItemDetailsGraphContentDefault = Template.bind({});
export const MaintenancePlanItemDetailsGraphContentMultiple = Template.bind({});
export const MaintenancePlanItemDetailsGraphContentEmpty = Template.bind({});

MaintenancePlanItemDetailsGraphContentDefault.args = {
  totalItems: [
    {
...
MaintenancePlanItemDetailsGraphContentEmpty.args = {
  totalItems: [],
};

MaintenancePlanItemDetailsGraphContentMultiple.args = {
  totalItems: [
    {
      id: '6e9df958-cb4d-4d5f-a38c-c31544eaa115',
      plan_id: 'd4d6ce04-1eb1-42fc-89ae-26abb6ac0c2b',
