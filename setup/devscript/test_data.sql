...
VALUES
    ...
    ('North Carolina Football Team', 'North Carolina football team', NULL, NULL, NULL, NULL, '35.12', '-78.22','Environment Development', 'Test Project Type', 100, array[(SELECT id FROM community.profiles LIMIT 1)::UUID], 250, false, NOW(), (SELECT id FROM community.profiles LIMIT 1), (SELECT id FROM community.profiles LIMIT 1), array[(SELECT id FROM community.profiles LIMIT 1)::UUID]),
    ('Worthington Football Team', 'Worthington Football Team', NULL, NULL, NULL, NULL, '39.96', '-82.99', 'Community Cause', 'Community Development', 100, array[(SELECT id FROM community.profiles LIMIT 1)::UUID], 250, true, NOW(), (SELECT id FROM community.profiles LIMIT 1), (SELECT id FROM community.profiles LIMIT 1), array[(SELECT id FROM community.profiles LIMIT 1)::UUID]),
    ('Austin Zoo Fair Show', 'Austin zoo fair show for children and adults', 'S Congress Ave', 'Austin', 'TX', '78702', '30.26', '-97.74', 'Community Cause', 'Community Development', 100, array[(SELECT id FROM community.profiles LIMIT 1)::UUID], 250, false, NOW(), (SELECT id FROM community.profiles LIMIT 1), (SELECT id FROM community.profiles LIMIT 1), array[(SELECT id FROM community.profiles LIMIT 1)::UUID]),
