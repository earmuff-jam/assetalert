...
VALUES
    ...
    (
        ...
        'Venue Rental',
        1000.00,
        (SELECT id FROM community.category ORDER BY category.item_name DESC LIMIT 1),
        'City Hall', 
    ...
    (
        ...
        'Sound System Rental', 
        300.00, 
        (SELECT id FROM community.category WHERE category.item_name='Electronics' LIMIT 1),
        'Audio Solutions', 
    ...
    (
        ...
        'Transportation', 
        150.00, 
        (SELECT id FROM community.category WHERE category.item_name='Travel' LIMIT 1),
        'City Limos', 
    ...
    (
        ...
        'Gifts for Attendees', 
        250.00, 
        (SELECT id FROM community.category WHERE category.item_name='Clothing' LIMIT 1),
        'Gifts R Us', 
    ...
    (
        ...
        'Security Services', 
        350.00, 
        (SELECT id FROM community.category WHERE category.item_name='Gifts/Donations' LIMIT 1),
        'Secure Events Co.', 
