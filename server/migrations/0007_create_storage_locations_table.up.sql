...
-- File: 0007_create_storage_locations_table.up.sql
...
ALTER TABLE asset.storage_locations
    OWNER TO asset_admin;

GRANT SELECT, INSERT, UPDATE, DELETE ON asset.storage_locations TO asset_public;
GRANT SELECT, INSERT, UPDATE, DELETE ON asset.storage_locations TO asset_test;
GRANT ALL PRIVILEGES ON TABLE asset.storage_locations TO asset_admin;