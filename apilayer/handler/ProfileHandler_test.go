...
func Test_GetUserRecentActivities(t *testing.T) {
...
func Test_GetUserRecentHighlights(t *testing.T) {
	...
	err = json.Unmarshal(data, &recentHighlight)
	if err != nil {
		t.Errorf("expected error to be nil got %v", err)
	}
...
func Test_GetEventsSharedWithSelectedUser(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, fmt.Sprintf("/api/v1/profile/%s/shared", prevUser.ID), nil)
	req = mux.SetURLVars(req, map[string]string{"id": prevUser.ID.String()})
	w := httptest.NewRecorder()
	GetEventsSharedWithSelectedUser(w, req, config.CTO_USER)
	res := w.Result()
	defer res.Body.Close()
	data, err := io.ReadAll(res.Body)
	if err != nil {
	...
	var recentEvents []model.Event
	err = json.Unmarshal(data, &recentEvents)
	if err != nil {
		t.Errorf("expected error to be nil got %v", err)
	}
...
func Test_GetEventsSharedWithSelectedUser_WrongEventID(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/api/v1/profile/0802c692-b8e2-4824-a870-e52f4a0cccf8/shared", nil)
	req = mux.SetURLVars(req, map[string]string{"id": "0802c692-b8e2-4824-a870-e52f4a0cccf8"})
	w := httptest.NewRecorder()
	db.PreloadAllTestVariables()
	GetEventsSharedWithSelectedUser(w, req, config.CTO_USER)
	...
	assert.Equal(t, 200, res.StatusCode)
	assert.Equal(t, len(recentEvents), 0)
}

func Test_GetEventsSharedWithSelectedUser_NoEventID(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/api/v1/profile/0802c692-b8e2-4824-a870-e52f4a0cccf8/shared", nil)
	req = mux.SetURLVars(req, map[string]string{"id": ""})
	w := httptest.NewRecorder()
	db.PreloadAllTestVariables()
...
func Test_GetEventsSharedWithSelectedUser_IncorrectEventID(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/api/v1/profile/0802c692-b8e2-4824-a870-e52f4a0cccf8/shared", nil)
	req = mux.SetURLVars(req, map[string]string{"id": "request"})
	w := httptest.NewRecorder()
	db.PreloadAllTestVariables()
...
func Test_GetEventsSharedWithSelectedUser_InvalidDBUser(t *testing.T) {
	req := httptest.NewRequest(http.MethodGet, "/api/v1/profile/0802c692-b8e2-4824-a870-e52f4a0cccf8/shared", nil)
	req = mux.SetURLVars(req, map[string]string{"id": "0802c692-b8e2-4824-a870-e52f4a0cccf8"})
	w := httptest.NewRecorder()
	db.PreloadAllTestVariables()
	GetEventsSharedWithSelectedUser(w, req, config.CEO_USER)
	res := w.Result()
